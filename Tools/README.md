**MosaicPlot.r:** Takes in RIA output and using metadata with self reported ethnicity generates a stacked barplot for the probability distribution for the 5 superpopulations for each sample.
